...
export const copy = {
  ...
  home: {
    ...
    aiAnswerScene: {
      headline: "Every clinic in the UAE could answer them like this.",
      caption: "Replies handled by your Novacare AI agent",
    },
    services: {
      ...
      tiers: [
        ...
        {
          label: "TIER TWO",
          headline: "Clinic Site, plus AI Reception.",
          price: "AED 12,000",
        ...
        },
        {
          ...
          introHeader: "What's included",
          features: [
            "Instagram DM automation",
            "No-show follow-up flows",
            "Ad landing pages, Meta and Google",
            "Performance dashboard",
            "Quarterly strategy with founders",
          ],
          ...
          dashboard: {
            ...
            chartPath:
              "M 0 60 L 20 56 L 40 58 L 60 50 L 80 52 L 100 44 L 120 40 L 140 36 L 160 30 L 180 18",
            chartViewBox: "0 12 180 54",
            secondary: [
              { label: "REPLIES HANDLED", value: "1,847", hoverValue: "1,851" },
              { label: "AVG RESPONSE", value: "8.2s", hoverValue: "8.1s" },
              { label: "SHOW RATE", value: "94%" },
            ],
          },
        },
      ],
