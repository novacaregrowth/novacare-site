...
const DEL_DASHBOARD = 0.3;
const DEL_HAIRLINE_2 = 0.6;
const DEL_INTRO_HEADER = 0.65;
const DEL_FEATURES_BASE = 0.7;
const DEL_HAIRLINE_3 = 0.95;
const DEL_META = 1.0;
const DEL_CTA = 1.05;
...
export function Tier3Panel({ play, isStatic }: Props) {
  const tier = copy.home.services.tiers[2];
    ...
    >
      ...
      >
        <ArtifactDashboard
          data={tier.dashboard}
          play={play}
          introDelaySec={CASCADE_START_SEC + DEL_DASHBOARD}
          hovered={hovered}
